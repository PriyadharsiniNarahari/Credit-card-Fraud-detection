...
setwd("D:/ASU/MSBA/CIS 508 Data Mining 1/My project")
...
#find the distribution of fraud and legitimate transaction
table(credit_card$Class)

#get the percentage of fraud and legitimate transaction
...
####------------------------------------------------------------------------------------------------------
###creating training and test set for fraud detection model
